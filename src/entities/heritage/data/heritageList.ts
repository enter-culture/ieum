...
export const heritageList: Heritage[] = [
  ...
  },
  {
    ...
    designatedAt: '1964년 12월 24일',
    holders: ['김기복', '양도일'],
    shortDesc: '유랑 예인 집단 남사당패가 펼치는 여섯 마당의 민속 공연',
    description: `남사당놀이는 남사당패라 불리는 유랑 예인 집단이 농어촌을 돌아다니며 서민들에게 보여주던 공연입니다.\n\n풍물·버나(대접돌리기)·살판(땅재주)·어름(줄타기)·덧뵈기(탈춤)·덜미(꼭두각시놀음) 등 여섯 마당으로 구성됩니다. 2009년 유네스코 인류무형문화유산에 등재되었습니다.`,
  ...
  },
  {
    ...
    number: '제76호',
    region: '전국',
    designatedAt: '1983년 6월 1일',
    holders: ['정경화', '이용복'],
    shortDesc: '유연한 몸놀림과 발기술이 특징인 한국 전통 무예',
    description: `택견은 유연하고 율동적인 몸동작으로 상대방을 제압하는 한국의 전통 무예입니다.\n\n부드러운 곡선 동작과 다양한 발기술을 특징으로 하며, 상대를 넘어뜨리는 것을 목표로 합니다. 2011년 유네스코 인류무형문화유산에 등재되었으며, 태권도의 원형으로도 알려져 있습니다.`,
